...
CanvasVideoPlayer.prototype.drawFrame = function() {
	...
	if (this.video.currentTime > 2.5 && this.video.currentTime < 3.5)
		this.ctx.drawImage(document.getElementById("img1"), 100, 100, 100, 100);
	if (this.video.currentTime > 4 && this.video.currentTime < 4.5)
		this.ctx.drawImage(document.getElementById("img1"), 100, 100, 100, 100);
	if (this.video.currentTime > 5 && this.video.currentTime < 5.5)
		this.ctx.drawImage(document.getElementById("img1"), 100, 100, 100, 100);
};
